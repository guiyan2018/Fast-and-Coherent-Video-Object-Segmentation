...
int main() {
	string openName = "backkom";  //filename for the input video
	video.open("D:/video_datasets/" + openName + ".avi");  //path for the input video
	...
	{
		// given key frames
		int key[4] = { 2,8,22,42 };  //keyframes
		for (int i = 0;i < 47;i++) {  //total number of the frames
